...
local C = {
    ...
    buildings = {
        ...
        requisition_office={label='Requisition Office',hp=900,armor=1,size=3,sight=8,cost={substrate=175,charge=25},buildTicks=T.ticks(35),tier=true},
        ...
        bunker={label='Bunker',hp=400,armor=2,size=2,sight=8,cost={substrate=100},buildTicks=T.ticks(20),requires={'mc_barracks'}}
    },
    statuses = {},
    abilities = {},
    factions = {
