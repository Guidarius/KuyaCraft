param([ValidateSet('twin_marches','river_pass','open_fields','movement_lab')][string]$Map = 'twin_marches', [string]$Faction = 'bastion', [switch]$Smoke, [int]$AutoQuit = 0, [string]$HostAddress = '', [string]$JoinAddress = '', [switch]$AssetViewer)
