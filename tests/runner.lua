...
test('simulation','incremental vision matches cold rebuild through movement ownership death construction and restore',function() require('tests.visibility_union').run() end)
