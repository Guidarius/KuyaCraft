# Responsive control, simulation 28 / content 15
...
- A stable active-search schedule avoids repeatedly scanning every entity per expansion. The A* budget remains 256 expansions/tick in shipping content. Shared-route connectors consume the existing direct-route budget. Every smoothing sample, including failed probes, consumes the smoothing budget; exhaustion retains the unsmoothed remainder.
...
The 64-cell wall-detour regression enforces first actual displacement within 40 ticks for 1/12/24/48 workers. All four measured 14 ticks (0.70 simulated seconds), versus the audited 48-worker p95 of 30.55 seconds. This is a synthetic navigation test, not a claim about all map situations. The shipping mixed 50-versus-50 two-cell choke completes at tick 874 with clearance and arrival checks.
